// Code generated by the Encore v1.45.6 client generator. DO NOT EDIT.
...
export function Environment(name: string): BaseURL {
    return `https://${name}-encore-demo-2hy2.encr.app`
}
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (typeof window === "undefined") {
            this.headers["User-Agent"] = "encore-demo-2hy2-Generated-TS-Client (Encore/v1.45.6)";
        }
    ...
    async getAuthData(): Promise<CallParameters | undefined> {
        ...
        if (authData) {
            ...
            data.headers = makeRecord<string, string>({
                sessiontoken: authData.authorization,
            });
